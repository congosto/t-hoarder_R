...
output:
  html_document:
    df_print: paged
params:
    dataset_name : "prueba"           # Nombre del dataset
    query        : "Warner since:2023-06-21 until:2023-06-25"       # Query para la búsqueda de tweets"       # Query para la búsqueda de tweets
    max_tweets   : 200                # Máximo número de tweets.
---
...
while (TRUE)
{
  # Bajamos los datos de 100 en 100 tweets para ir salvándolos en un fichero y evitar
