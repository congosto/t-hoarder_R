...
params:
    ...
    base_title : "xxxxxxxxxxx"        # Prefijo del título principal de las gráficas
...
```{r origen_tweets_by_community, fig.height=14, fig.width=9, message=FALSE, warning=FALSE}
if(ARS) {
...
```{r contenido_tweets_by_community, fig.height=14, fig.width=9, message=FALSE, warning=FALSE}
if(ARS) {
