...
output:
  html_document:
    df_print: paged
params:
    dataset_name: "xxxxxxx"        # Nombre del dataset
...
```{r daily_activity_total, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r daily_activity_zoom, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
if(zoom) {
...
```{r impact_fav_total, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r impact_fav_zoom, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
if(zoom) {
  my_color <- c("Num. original tweets" = "#33E9FF", "Fav" = "red4")
...
```{r impact_rt_total, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r impact_rt_zoom, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
if(zoom) {
  my_color <- c("Num. original tweets" = "#33E9FF", "RTs" = "red4")
...
```{r impact_replies_total, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r impact_replies_zoom, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
if(zoom) {
  my_color <- c("Num. original tweets" = "#33E9FF", "Replies" = "red4")
...
```{r impact_quotes_total, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r impact_quotes_zoom, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
if(zoom) {
  my_color <- c("Num. original tweets" = "#33E9FF", "Quotes" = "red4")
...
```{r impact_impresions_total, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r impact_impresions_zoom, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r endgadgement_total, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r Endgadgement_zoom, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, paged.print=FALSE}
if(zoom & params$date_end_zoom >= "2022-12-15") {
