...
output:
  html_document:
    df_print: paged
params:
    dataset_name : "trends"          # Nombre del dataset
    query : "retweets_of:publico_es, retweets_of:el_pais, retweets_of:eldiarioes, retweets_of:okdiario, retweets_of:abc_es, retweets_of:elmundoes, retweets_of:elconfidencial, retweets_of:larazon_es, retweets_of:elperiodico, retweets_of:LaVanguardia"
    base_title : "RTs recibidos por los digitales"
    granularity : "hour"                  # Unidad de tiempo: hour| day | week | month
    time_zone: "Europe/Berlin"           # Huso horario
    start_time   : "2023-05-12 00:00:00" # Formato YYYY-MM-DD 00:00:00. Por defecto fecha de creación de Twitter
    end_time     : "2023-05-28 00:00:00" # Formato YYYY-MM-DD 00:00:00. por defecto, hora GMT actual 
